...
def run_process_epub(input_epub, mode, profile_key=None, replacement_cover=None):
    ...
    try:
        ...
        return f"Success!\nOptimized file saved next to original EPUB."
    except Exception as e:
...
class MainMenuScreen(Screen):
    def __init__(self, **kwargs):
        ...
        btn1 = Button(text="1. Change Cover Photo", size_hint_y=0.2)
        btn1.bind(on_press=lambda x: self.go_to_file_select("1"))
        
        btn2 = Button(text="2. Optimize Images Only", size_hint_y=0.2)
        btn2.bind(on_press=lambda x: self.go_to_file_select("2"))
        
        btn3 = Button(text="3. Set Language to 'en'", size_hint_y=0.2)
...
class FileSelectScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="Select an EPUB file:", size_hint_y=0.1)
    ...
    def confirm_selection(self, instance):
        ...
        if not selection:
            self.label.text = "Tap a file to highlight it first!"
            return
...
class CoverSelectScreen(Screen):
    def __init__(self, **kwargs):
        ...
        layout.add_widget(Label(text="Select New Cover Image (.jpg/.png):", size_hint_y=0.1))
...
class ProfileSelectScreen(Screen):
    def __init__(self, **kwargs):
        ...
        layout.add_widget(Label(text="Select Kindle Device Resolution:", font_size='18sp', size_hint_y=0.15))
        ...
        for key, value in KINDLE_PROFILES.items():
            btn = Button(text=f"{value['name']} ({value['width']}x{value['height']})", size_hint_y=None, height=65)
...
class StatusScreen(Screen):
    def __init__(self, **kwargs):
        ...
        home_btn.bind(on_press=lambda x: setattr(self.manager, 'current', 'main_menu'))
